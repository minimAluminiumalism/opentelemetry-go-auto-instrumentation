...
func init() {
	TestCases = append(TestCases,
		NewGeneralTestCase("eino-react-agent-test", eino_module_name, "v0.3.51", "", "1.24", "", TestReactAgentEino),
		NewGeneralTestCase("eino-openai-invoke-test", eino_module_name, "v0.3.51", "", "1.24", "", TestOpenAIInvokeEino),
		NewGeneralTestCase("eino-openai-stream-test", eino_module_name, "v0.3.51", "", "1.24", "", TestOpenAIStreamEino),
		NewGeneralTestCase("eino-ollama-invoke-test", eino_module_name, "v0.3.51", "", "1.24", "", TestOllamaInvokeEino),
		NewGeneralTestCase("eino-ollama-stream-test", eino_module_name, "v0.3.51", "", "1.24", "", TestOllamaStreamEino),
		NewGeneralTestCase("eino-ark-invoke-test", eino_module_name, "v0.3.51", "", "1.24", "", TestArkInvokeEino),
		NewGeneralTestCase("eino-ark-stream-test", eino_module_name, "v0.3.51", "", "1.24", "", TestArkStreamEino),
		NewGeneralTestCase("eino-claude-invoke-test", eino_module_name, "v0.3.51", "", "1.24", "", TestClaudeInvokeEino),
		NewGeneralTestCase("eino-claude-stream-test", eino_module_name, "v0.3.51", "", "1.24", "", TestClaudeStreamEino),
		NewGeneralTestCase("eino-qwen-invoke-test", eino_module_name, "v0.3.51", "", "1.24", "", TestQwenInvokeEino),
		NewGeneralTestCase("eino-qwen-stream-test", eino_module_name, "v0.3.51", "", "1.24", "", TestQwenStreamEino),
